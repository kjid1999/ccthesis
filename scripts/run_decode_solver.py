...
if __name__ == '__main__':
    ...
    parser.add_argument('--split', type=str, default='test', choices=['train', 'train_part', 'valid', 'test'], help='dataset split used to decode')
    ...
    for lst in glob.glob(args.model_dir):
        ...
        # print(glob.glob(f"{lst}/{args.pattern}*{args.sel_ckpt}*pt"))
