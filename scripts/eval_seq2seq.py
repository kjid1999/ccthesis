...
if __name__ == '__main__':
    ...
    parser.add_argument('--select_step', type=str, default='', help='only evaluate generation with seleted step')
    ...
    files = sorted([file for file in files if f'step{args.select_step}' in file])
    sample_num = 0
