...
if __name__ == '__main__':
    ...
    parser.add_argument('--delay_opt', type=int, default=1, help='call optimizer step after some batchs')
    parser.add_argument('--_lambda', type=float, default=0., help='hyperpara. in importance noisy schedule')
    ...
    COMMANDLINE = f" OPENAI_LOGDIR={Model_FILE}  " \
                  ...
                  f"--reg_rate {args.reg_rate} --_lambda {args._lambda}"
